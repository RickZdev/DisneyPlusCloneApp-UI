    ...
    <View className="flex-row justify-between pt-2 mb-6">
      ...
      <View>
        <View className="flex-row">
          ...
          <Entypo name="chevron-small-down" size={22} color={COLORS.white} />
        </View>
        <Text className="text-white font-RobotoMedium text-base">Disney+</Text>
      ...
      <View className="items-center space-y-1">
        <LinearGradient
          ...
          <TouchableOpacity className="justify-center items-center px-10 py-2 rounded-full ">
            <Text className="text-white font-RobotoMedium">Subscribe</Text>
          </TouchableOpacity>
        </LinearGradient>
...
const ProfileContent = ({width}) => {
  return (
    <View className="flex-1">
      ...
      <View className="pt-6 ">
        <View className="flex-row items-center justify-between">
          <Text className="text-white font-RobotoBold text-lg">Profiles</Text>

          <View className="flex-row items-center space-x-2">
            <Octicons name="pencil" size={12} color={COLORS.white} />
            <Text className="text-white font-RobotoMedium text-xs">Edit</Text>
          </View>
        </View>
